...
public:
    //==============================================================================
    EulerDelayAudioProcessor();
    ~EulerDelayAudioProcessor() override;
    ...
    juce::AudioProcessorValueTreeState& getmApvts();
    
    MyPresetManager& getPresetManager() noexcept;
...
private:
    ...
    void updateBpm(double& outBpm) noexcept;
    
    ModulePingPong mModulePingPong;
    
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EulerDelayAudioProcessor)
};
